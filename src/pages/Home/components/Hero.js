  ...
  return (
    <section className='flex flex-col lg:flex-row dark:text-slate-100 items-center'>
        <div className='my-5 text-center lg:text-left lg:ml-10'> 
            ...
            <p className='text-lg sm:text-xl lg:text-2xl my-5 px-5 lg:px-1 dark:text-slate-300'>Most Popular Books Of All Genre With All Category.<br/>Find Ratings and Access to the Newest Books Digitally.</p>
